...
- **Módulos o Funcionalidades Críticas:**
  ...
  - Menú de navegación condicional: la barra de navegación muestra contenido diferenciado según el estado de sesión. Para usuarios no autenticados muestra los botones "Turnos" y "Solicitar Turno" (antes "Registrar"), además de "Iniciar Sesión". Para usuarios autenticados muestra "Turnos", "Historial Turnos" (antes "Dashboard"), "Gestión Médicos" y "Solicitar Turno", junto al botón de cerrar sesión.
