...
- **Módulos o Funcionalidades Críticas:**
  ...
  - Menú de navegación condicional: la barra de navegación muestra contenido diferenciado según el estado de sesión. Para usuarios no autenticados muestra los botones "Solicitar Turno" (antes "Registrar") e "Iniciar Sesión". Para usuarios autenticados muestra "Turnos", "Dashboard", "Gestión Médicos" y "Solicitar Turno", junto al botón de cerrar sesión.
