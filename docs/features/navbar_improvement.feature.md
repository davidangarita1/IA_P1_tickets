...
**Quiero** que el botón "Registrar" se llame "Solicitar Turno", que la ruta `/register` cambie a `/request-turn`, y que este botón sea visible en la barra de navegación sin necesidad de iniciar sesión
