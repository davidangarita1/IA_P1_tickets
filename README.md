...
- Barra de navegación pública: usuarios no autenticados acceden a "Request Turn" (`/request-turn`) directamente desde la barra de navegación, sin necesidad de conocer la URL. La ruta anterior `/register` redirige automáticamente a `/request-turn`.
