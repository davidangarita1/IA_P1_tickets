...
- Barra de navegación pública: usuarios no autenticados acceden a "Solicitar Turno" (`/solicitar-turno`) directamente desde la barra de navegación, sin necesidad de conocer la URL. La ruta anterior `/register` redirige automáticamente a `/solicitar-turno`.
