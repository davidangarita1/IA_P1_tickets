...
# Context
You must generate all test plans strictly following the structure defined in the `test_plan.template.md` file. The test plans should cover objectives, scope, user stories, acceptance criteria, test scenarios, risk assessment, and required team structure.

# Instructions
1. Read the provided feature descriptions, software requirements, or user stories.
2. Load the `test_plan.template.md` file to understand the exact required output structure.
